 ...
 *
 * <p><b>Post-FE-4c change: {@code clientId} was removed too.</b> The OAuth2 {@code client_id} is now generated by
 * the backend from {@code clientName} ({@link com.anterka.closeauthbackend.client.service.ClientIdGenerator}),
 * exactly like the secret above — there is nothing for an operator to usefully type here, and a caller-chosen value
 * risks collisions/typos the generator sidesteps by construction. The generated id is returned on
 * {@link com.anterka.closeauthbackend.client.dto.ClientCreatedView}.
 *
 * @param clientName     display name (also the seed the generated {@code client_id} is slugified from).
