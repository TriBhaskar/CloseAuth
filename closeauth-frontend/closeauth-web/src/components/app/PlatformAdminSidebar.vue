...
// Stage UI-4: forked from TenantAdminSidebar.vue rather than parameterizing
// AppSidebar.vue — same reasoning UI-3b gave for its own fork: this tree is
// PLATFORM_ADMIN-scoped (/platform/console/*, no slug), not the tenant one,
// and AppSidebar's nav array is hardcoded to nonexistent `/admin/*` paths
// anyway (it and AdminLayout.vue are deleted by this stage). Deliberately
// two nav entries only — Tenants and Platform admins — matching the brief's
// "deliberately small" scope; no third entry exists to add.
import { computed } from 'vue'
import { RouterLink, useRoute } from 'vue-router'
import { ChevronLeft, ChevronRight, ShieldAlert, Users2, Building2 } from 'lucide-vue-next'
