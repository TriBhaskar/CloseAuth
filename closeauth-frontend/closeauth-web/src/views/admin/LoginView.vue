...
<template>
  <AuthLayout>
    ...
    <div
      v-if="oauthFlow"
      class="flex items-start gap-2 rounded-md border border-blue-500/20 bg-blue-500/10 px-3.5 py-3"
      role="status"
    >
      <Info class="mt-0.5 h-3.5 w-3.5 shrink-0 text-blue-600 dark:text-blue-400" aria-hidden="true" />
    ...
    <form class="space-y-4" @submit.prevent="handleSubmit">
      ...
      <div class="space-y-1.5">
        <Label for="username" class="text-sm font-medium leading-none">Email</Label>
        <Input
          id="username"
          v-model="username"
          type="email"
    ...
    <div class="grid grid-cols-2 gap-3">
      <Button variant="outline" type="button" class="h-9 items-center justify-center gap-2 transition-all active:scale-[0.98]">
        <svg aria-hidden="true" class="h-4 w-4" focusable="false" role="img" viewBox="0 0 488 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <Button variant="outline" type="button" class="h-9 items-center justify-center gap-2 transition-all active:scale-[0.98]">
        <svg aria-hidden="true" class="h-4 w-4" focusable="false" role="img" viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
